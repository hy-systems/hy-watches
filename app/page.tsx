    ...
    <>
      ...
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        >
          ...
          >
            <h1 className="text-[clamp(3rem,8vw,7rem)] leading-[0.9] text-white font-serif">
              Precision timepieces.
            </h1>
            <h1 className="text-[clamp(3rem,8vw,7rem)] leading-[0.9] text-[#888888] italic mt-2 font-serif">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {collection.map((watch, i) => (
            <motion.div 
              ...
              className="group relative bg-[#0A0A0A] border border-white/10 p-10 overflow-hidden hover:border-[#D4AF37]/40 transition-colors duration-700"
            >
