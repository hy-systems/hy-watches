  ...
  const products = [
    {
      ...
      size: '41.5mm',
      movement: 'Automatic',
      image: 'https://www.unimaticwatches.com/cdn/shop/files/U1-AEG-Hero.png?v=1785834515&width=900',
    },
    {
      id: 'u1-aeb',
      ...
      size: '41.5mm',
      movement: 'Automatic',
      image: 'https://www.unimaticwatches.com/cdn/shop/files/U1-AEB-Hero.png?v=1785834514&width=900',
    },
    {
      id: 'u1-gmt-aeg',
      ...
      size: '41.5mm',
      movement: 'Automatic',
      image: 'https://www.unimaticwatches.com/cdn/shop/files/U1-GMT-AEG-Hero.png?v=1785834559&width=900',
    },
    {
      id: 'u4-gmt-aeb',
      ...
      size: '40mm',
      movement: 'Automatic',
      image: 'https://www.unimaticwatches.com/cdn/shop/files/U4-GMT-AEB-Hero.png?v=1785834740&width=900',
    }
  ];

  return (
    <div className="bg-[#F6F6F6] min-h-screen text-[#000000] font-sans selection:bg-[#AFFF00] selection:text-black">
      ...
      <section className="relative w-full h-[85vh] bg-black overflow-hidden flex flex-col justify-end">
        ...
        >
          <source src="https://lucytimepieces.com/wp-content/uploads/2026/09/rolex-unboxing.mp4" type="video/mp4" />
        </video>
      ...
      <section className="w-full grid grid-cols-1 md:grid-cols-2">
        {[
          { title: 'Classic', sub: 'Explore our most iconic permanent line.', img: 'https://www.unimaticwatches.com/cdn/shop/files/HP_Block_Classic-U2.jpg?v=1788009438&width=1600' },
          { title: 'Toolwatches', sub: 'Explore our purpose-built toolwatches.', img: 'https://www.unimaticwatches.com/cdn/shop/files/Toolwatch_Focus_03.jpg?v=1787649716&width=1600' },
          { title: 'Collaborations', sub: 'Explore our latest collaborations.', img: 'https://www.unimaticwatches.com/cdn/shop/files/HP_Collaboration_Block.jpg?v=1787753713&width=1600' },
          { title: 'Limited Edition', sub: 'Explore our most exclusive releases.', img: 'https://www.unimaticwatches.com/cdn/shop/files/HP_LimitedEdition_Block_PreLive.jpg?v=1787753712&width=1600' }
        ].map((block, i) => (
      ...
      <section className="w-full px-4 md:px-8 py-24 max-w-[1920px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
          {[
            { title: 'Waterproof checked', desc: 'All watches are water resistance checked to at least 300m to ensure reliability and durability in all conditions, from daily wear to underwater use.', img: 'https://www.unimaticwatches.com/cdn/shop/files/thumb_wr.jpg?v=1787864118&width=1200' },
            { title: 'Accuracy regulated & tested', desc: 'HY watches feature accuracy-tested movements, ensuring reliable and precise timekeeping across all models.', img: 'https://www.unimaticwatches.com/cdn/shop/files/thumb_testing_d3867386-d0f6-4bbe-a3de-136a81728afd.jpg?v=1787864324&width=1200' },
            { title: 'Quality checked and certified', desc: 'HY watches are quality checked by our experts, reflecting our commitment and pride in delivering the best craftsmanship, performance, and durability possible.', img: 'https://www.unimaticwatches.com/cdn/shop/files/thumb_quality-check.jpg?v=1787864339&width=1200' }
          ].map((feature, i) => (
