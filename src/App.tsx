        ...
        <div className="relative w-full h-[100svh] bg-[#050505] overflow-hidden flex items-center justify-center">
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: `
              <video class="w-full h-full object-cover opacity-60 slow-zoom pointer-events-none" preload="auto" playsinline webkit-playsinline autoplay muted loop poster="https://lucytimepieces.com/wp-content/uploads/2026/03/rolex-daytona-116500ln-stainless-steel-white-panda-dial-2018-rolex-1212087379.jpg">
